"""Unit tests for mugen.core.plugin.line.messagingapi.fw_ext."""
...
from mugen.core.plugin.line.messagingapi import fw_ext


class TestMugenLineMessagingapiFWExt(unittest.IsolatedAsyncioTestCase):
    """Covers LINE FW extension provider wiring and setup path."""
    ...
    async def test_setup_imports_webhook_module(self) -> None:
        ext = fw_ext.LineMessagingAPIFWExtension(
