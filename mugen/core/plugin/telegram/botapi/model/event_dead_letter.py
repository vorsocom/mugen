"""Provides an ORM for Telegram webhook dead-letter events."""

__all__ = ["TelegramBotAPIEventDeadLetter"]
...
class TelegramBotAPIEventDeadLetter(ModelBase):
    """An ORM for persisted Telegram webhook processing failures."""

    __tablename__ = "telegram_botapi_event_dead_letter"
    ...
    def __repr__(self) -> str:
        return f"TelegramBotAPIEventDeadLetter(id={self.id!r})"
