"""Provides an ORM for Telegram webhook event dedupe records."""

__all__ = ["TelegramBotAPIEventDedup"]
...
class TelegramBotAPIEventDedup(ModelBase):
    """An ORM for durable Telegram webhook dedupe keys."""

    __tablename__ = "telegram_botapi_event_dedup"
    ...
    def __repr__(self) -> str:
        return f"TelegramBotAPIEventDedup(id={self.id!r})"
