"""Provides an ORM for WhatsApp webhook event dedupe records."""

__all__ = ["WhatsAppWACAPIEventDedup"]
...
class WhatsAppWACAPIEventDedup(ModelBase):
    """An ORM for durable WhatsApp webhook dedupe keys."""

    __tablename__ = "whatsapp_wacapi_event_dedup"
    ...
    def __repr__(self) -> str:
        return f"WhatsAppWACAPIEventDedup(id={self.id!r})"
