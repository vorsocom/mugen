"""Provides an ORM for WeChat webhook dead-letter events."""

__all__ = ["WeChatEventDeadLetter"]
...
class WeChatEventDeadLetter(ModelBase):
    """An ORM for persisted WeChat webhook processing failures."""

    __tablename__ = "wechat_event_dead_letter"
    ...
    def __repr__(self) -> str:
        return f"WeChatEventDeadLetter(id={self.id!r})"
