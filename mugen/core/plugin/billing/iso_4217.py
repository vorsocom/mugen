"""Pinned ISO 4217 active currency registry used by billing migrations."""
...
ISO_4217_SHA256 = "838dfb991648cf36df939edd5fe3811737962b75a32252847d239cedd1e291c9"
ISO_4217_SOURCE = (
    "https://www.six-group.com/dam/download/financial-information/"
    "data-center/iso-currrency/lists/list-one.xml"
)

# (alphabetic code, numeric code, minor unit, currency name).
# A null minor unit represents the ISO registry value N.A.
ISO_4217_CURRENCIES: tuple[tuple[str, str, int | None, str], ...] = (
    ...
    ("XDR", "960", None, "SDR (Special Drawing Right)"),
    ("XOF", "952", 0, "CFA Franc BCEAO"),
    ("XPD", "964", None, "Palladium"),
    ("XPF", "953", 0, "CFP Franc"),
    ("XPT", "962", None, "Platinum"),
    ("XSU", "994", None, "Sucre"),
