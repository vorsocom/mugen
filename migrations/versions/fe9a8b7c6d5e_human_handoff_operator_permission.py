"""Seed ACP human handoff operator permission.

Revision ID: fe9a8b7c6d5e
Revises: fd4e1b2c3a9d
...
def upgrade() -> None:
    """Apply ACP manifest so the human handoff operator permission is seeded."""
