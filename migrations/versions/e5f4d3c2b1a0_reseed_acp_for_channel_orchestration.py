"""Re-apply ACP manifest for channel_orchestration contributions.
...
down_revision: Union[str, Sequence[str], None] = "d4c3b2a1f0e9"
...
def upgrade() -> None:
    """Apply ACP manifest so channel_orchestration resources are seeded."""
