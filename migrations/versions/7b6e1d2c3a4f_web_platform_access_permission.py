"""Seed ACP web platform access permission.

Revision ID: 7b6e1d2c3a4f
...
def upgrade() -> None:
    """Apply ACP manifest so the web platform access permission is seeded."""
