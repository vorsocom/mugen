"""signal restapi ipc reliability tables

Revision ID: 3d9a5c7b1e2f
Revises: 2f8b4c1d9e7a
...
revision: str = "3d9a5c7b1e2f"
down_revision: Union[str, Sequence[str], None] = "2f8b4c1d9e7a"
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_signal_restapi_event_dedup_event_type",
        "signal_restapi_event_dedup",
        ["event_type"],
        unique=False,
        schema=_SCHEMA,
    ...
    op.create_index(
        "ix_signal_restapi_event_dedup_dedupe_key",
        "signal_restapi_event_dedup",
        ["dedupe_key"],
        unique=False,
        schema=_SCHEMA,
    ...
    op.create_index(
        "ix_signal_restapi_event_dedup_event_id",
        "signal_restapi_event_dedup",
        ["event_id"],
        unique=False,
        schema=_SCHEMA,
    ...
    op.create_index(
        "ix_signal_restapi_event_dedup_expires_at",
        "signal_restapi_event_dedup",
        ["expires_at"],
        unique=False,
        schema=_SCHEMA,
    ...
    op.create_index(
        "ix_signal_restapi_dead_letter_event_type",
        "signal_restapi_event_dead_letter",
        ["event_type"],
        unique=False,
        schema=_SCHEMA,
    ...
    op.create_index(
        "ix_signal_restapi_dead_letter_dedupe_key",
        "signal_restapi_event_dead_letter",
        ["dedupe_key"],
        unique=False,
        schema=_SCHEMA,
    ...
    op.create_index(
        "ix_signal_restapi_dead_letter_reason_code",
        "signal_restapi_event_dead_letter",
        ["reason_code"],
        unique=False,
        schema=_SCHEMA,
    ...
    op.create_index(
        "ix_signal_restapi_dead_letter_status",
        "signal_restapi_event_dead_letter",
        ["status"],
        unique=False,
        schema=_SCHEMA,
    ...
    op.create_index(
        "ix_signal_restapi_dead_letter_last_failed_at",
        "signal_restapi_event_dead_letter",
        ["last_failed_at"],
        unique=False,
        schema=_SCHEMA,
