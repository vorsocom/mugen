"""Seed handoff operator tenant read grant.

Revision ID: 2d6a4f8c9b1e
Revises: 9e4d7c2b1a6f
...
def upgrade() -> None:
    """Apply ACP manifest so the handoff operator tenant read grant is seeded."""
