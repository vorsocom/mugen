"""Re-apply ACP manifest for ops_reporting contributions.

Revision ID: c2e4f6a8d0b2
Revises: b1d3f5a7c9e1
...
down_revision: Union[str, Sequence[str], None] = "b1d3f5a7c9e1"
...
def upgrade() -> None:
    """Apply ACP manifest so ops_reporting resources are seeded."""
