"""Seed ACP least privilege global roles.

Revision ID: 9e4d7c2b1a6f
Revises: 7b6e1d2c3a4f
...
def upgrade() -> None:
    """Apply ACP manifest so least privilege global roles are seeded."""
